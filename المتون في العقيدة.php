...
<fieldset id="A2">
    ...
    <section>
       ...
       <!----------------------------------------------------------------> 
        <center> 
            <h1 class="anwan">المتون في العقيدة</h1>
  ...
  <center>
    ...
    if(mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $imagePath = "الصور للكتب/العقيدة/الصور لمتون العقيدة/" . $row['IMAGE_PATH'];
            $filePath  = "الكتب الموجودة/كتب العقيدة/المتون في العقيدة/" . $row['FILE_PATH'];
    ?>
...
<iframe id="pdfViewer" src="" frameborder="0" type="application/pdf"></iframe>
        ...
        <div class="modal-footer">
            <p>مكتبة أبو أسوة&nbsp&nbsp&nbsp&nbspقراءة ممتعة</p>
        </div>
    </div>
